...
- (NSString *)documentsPathForFileName:(NSString *)name {
	...
	[manager createDirectoryAtPath:[NSString stringWithFormat:@"%@/TechTatva-16/Data", [paths lastObject]] withIntermediateDirectories:YES attributes:nil error:nil];
	return [documentsPath stringByAppendingPathComponent:[NSString stringWithFormat:@"TechTatva-16/Data/%@", name]];
}
...
- (NSString *)imagesPathForFileName:(NSString *)name {
	...
	NSArray *paths = NSSearchPathForDirectoriesInDomains(NSApplicationSupportDirectory, NSUserDomainMask, YES);
	NSString *documentsPath = [NSString stringWithFormat:@"%@", [paths lastObject]];
	[manager createDirectoryAtPath:[NSString stringWithFormat:@"%@/TechTatva-16/Images", [paths lastObject]] withIntermediateDirectories:YES attributes:nil error:nil];
	return [documentsPath stringByAppendingPathComponent:[NSString stringWithFormat:@"TechTatva-16/Images/%@", name]];
}
