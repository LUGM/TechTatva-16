...
@interface InstagramFullViewController ()
...
@implementation InstagramFullViewController
...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    [self sendRequestWithUrl:[NSURL URLWithString:_imageUrl]];
