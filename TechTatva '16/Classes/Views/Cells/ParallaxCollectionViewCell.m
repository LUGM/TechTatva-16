...
- (void)setupImageView {
	...
	self.parallaxImageView = [[UIImageView alloc] initWithFrame:CGRectMake(self.bounds.origin.x - 4, self.bounds.origin.y - 4, self.bounds.size.width + 8, IMAGE_HEIGHT + 8)];
